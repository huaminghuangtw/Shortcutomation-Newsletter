...
What if the goal wasn’t a “workout”? What if the goal was just **one minute**?
...
Here is how I used technology to build a [daily exercise habit](https://www.strava.com/athletes/huaminghuang) that sticks.

# The Science of “Exercise Snacking”

First, let’s address the biggest question: is one minute of exercise enough?

Science says yes.

A [2022 review](https://doi.org/10.1249/JES.0000000000000275) highlights that performing short, intense bursts of vigorous exercise (≤1 min) throughout the day is a feasible and time-efficient way to improve cardiorespiratory fitness and offset the negative effects of sedentary lifestyle.
...
In the book _[Atomic Habits](https://jamesclear.com/atomic-habits)_, [James Clear](https://www.google.com/search?q=James+Clear) argues that the biggest barrier to a new habit isn’t ability—it’s **friction**.
...
However, manually visiting a website every day creates friction. The key is to automate the delivery of this exercise, so that I don’t have to remember to do it.

Here’s my setup:

1. I configured a Personal Automation in the Shortcuts app to trigger [my custom “Daily Exercise” shortcut](https://shortcutomation.com/daily-exercise) daily at 1:00 PM—the specific time I [hit my post-lunch slump](https://huami.ng/2025/07/30/how-i-use-shortcuts-to-recharge-my-brain) and need to wake my body up.
...
Begin with a single notification. Give it one minute. You’ll be amazed how far that tiny first step can take you.
